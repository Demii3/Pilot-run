<?php
    ...
    $work_classification = $items['workClassification'] ?? 'R';
    ...
    mysqli_stmt_bind_param($stmt, 'sssssiisi', $date, $clock_in, $clockin_status, $clock_out, $clockout_status, $duration, $allow_overtime, $work_classification, $attendance_id);
